...
if __name__ == '__main__':
    ...
    if user_1.is_valid_password("Pass") is not False:
        print("is_valid_password should return False if pwd is not correct")

    if user_1.is_valid_password("myPassword") is not True:
        print("is_valid_password should return True if it's the right password")

    if user_2.is_valid_password("myPassword") is not False:
